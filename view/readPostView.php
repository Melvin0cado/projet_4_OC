...
<?php if (isset($post)) {
    ...
    <form class="form-comment my-2" method="post" action="index.php?action=create_comment&postId=<?= $post['id'] ?>">
        <div class="row mb-2">
            <div class="col-2">
...
<?php
    ...
    foreach ($commentList as $comment) { ?>
        ...
        <div class="comment-header card-header d-flex justify-content-between">
