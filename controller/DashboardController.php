...
final class DashboardController
{
    ...
    public function load() {
        ...
        $lastPost = $this->db->query('SELECT * FROM `post` LIMIT 5', 'Post', true);
        $mostReportedComment = $this->db->query('SELECT * FROM `comment` ORDER BY report_number DESC LIMIT 5', 'Comment', true);
